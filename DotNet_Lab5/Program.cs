...
namespace DotNet_Lab5
{
    ...
    class Board
    {
        ...
        public void Draw()
        {
            ...
            {
                // Также корректируем координаты, потому что "у" рисуется не на самой первой строке доски, а ниже
                // "х" рисуется с учетом расстояния (табуляция) между точками доски
